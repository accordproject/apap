...
export interface components {
  schemas: {
    ...
    /**
     * StateResponse 
     * @description An instance of org.accordproject.protocol@1.0.0.StateResponse
     */
    "org.accordproject.protocol@1.0.0.StateResponse": {
      /**
       * @description The class identifier for org.accordproject.protocol@1.0.0.StateResponse 
       * @default org.accordproject.protocol@1.0.0.StateResponse
       */
      $class: string;
      status: components["schemas"]["org.accordproject.protocol@1.0.0.AgreementStatusType"];
      result: string;
    };
    /**
     * Node 
...
export interface operations {
  ...
  agreementState: {
     ...
     */
    responses: {
      /** @description Successful response - returns the state of an `agreement`. */
      200: {
        content: {
          "application/json": components["schemas"]["org.accordproject.protocol@1.0.0.StateResponse"];
        };
      };
    };
  };
